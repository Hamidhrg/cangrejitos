...
# file names
fp = "/AbsoluteFilePATH/" # edit to provide an absolute filepath
plot_fn = paste(fp, "output/Simple.range.pdf",sep="")
tree_fn = paste(fp, "output/Simple.ase.tre", sep="")
label_fn = paste(fp, "data/state_labels.simple.n7.txt", sep="")
color_fn = paste(fp, "data/range_colors.n7.txt", sep="")
